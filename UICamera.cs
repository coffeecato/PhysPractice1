...
public class UICamera : MonoBehaviour
{
    ...
    //    Ray ray = UICamera.currentCamera.ScreenPointToRay(new Vector3(position.x, position.y, 0));
        
    //    //bool touchUI = Physics.Raycast(ray, Mathf.Infinity, 1 << LayerMask.NameToLayer("UI"));
    //    RaycastHit hitInfo;
    //    bool touchUI = Physics.Raycast(ray, out hitInfo, Mathf.Infinity, 1 << LayerMask.NameToLayer("UI"));
    //    if (hitInfo.transform != null)
    //        Debug.LogWarning("hit the object: " + hitInfo.transform.gameObject.name);
    //    return !touchUI;
    //}
	...
	void Start ()
	{
        ...
        //if (UICamera.FindCameraForLayer(5) != null)
        //    NGUICamera = UICamera.FindCameraForLayer(5).GetComponent<Camera>();
